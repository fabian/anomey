{layout template="Admin/edit.tpl" title="Content"}
  ...
  {form}
   ...
   <fieldset>
    <legend><span>Join</span></legend>
                     
    <div class="text last">
     <label for="url" title="Url of join.">URL <span class="required" title="Required">*</span></label><br />
     <input type="text" name="url" id="url" value="{$form.url}" title="Url of join." />
    </div>
   </fieldset>
