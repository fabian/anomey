{layout template="Admin/News/layout.tpl" title="Settings"}
  ...
  {form}
   ...
   <fieldset>
    ...
    <div class="html">
     <textarea name="preface" id="preface" rows="12" cols="32" title="Preface of the news page.">{$form.preface}</textarea>
    </div>
   </fieldset>  
