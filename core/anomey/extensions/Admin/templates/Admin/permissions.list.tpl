...
<tr>
	...
	<td><ul class="actions"><li>{link trail="admin/security/permissions/change/`$page.id`/`$permission.name`"}<a href="{$href}" class="action edit">change allowed users</a>{/link}</li></ul></td>
</tr>
{/foreach}
