...
require_once 'admin.package.php';
require_once 'admin.designs.package.php';
require_once 'admin.pages.package.php';
require_once 'admin.security.package.php';
require_once 'admin.settings.package.php';
